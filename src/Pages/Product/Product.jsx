        ...
        <div className="flex-[2] Outfit">
          ...
          <div className="mt-[25px] w-fit border-b-[2px] border-gray-300 border-solid pb-[20px]">
            ...
            <div className="flex justify-between">
              ...
              <div>
                <span className="text-[14px] font-[600] underline">
                  Size Chart
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-[10px] mt-[10px] flex-wrap">
              <div
                className={`py-[7px] px-[25px] ${
                  selectedSize === 0 ? "text-white" : "text-black"
                } ${selectedSize === 0 ? "bg-black" : "bg-white"} ${
                  selectedSize === 0 ? "hover:bg-black/90" : "hover:bg-gray-100"
                } border-black border-solid border-[1px] flex items-center justify-center rounded-full text-[16px] font-[500] cursor-pointer transition-colors`}
              ...
              <div
                className={`py-[7px] px-[25px] ${
                  selectedSize === 1 ? "text-white" : "text-black"
                } ${selectedSize === 1 ? "bg-black" : "bg-white"} ${
                  selectedSize === 1 ? "hover:bg-black/90" : "hover:bg-gray-100"
                } border-black border-solid border-[1px] flex items-center justify-center rounded-full text-[16px] font-[500] cursor-pointer transition-colors`}
              ...
              <div
                className={`py-[7px] px-[25px] ${
                  selectedSize === 2 ? "text-white" : "text-black"
                } ${selectedSize === 2 ? "bg-black" : "bg-white"} ${
                  selectedSize === 2 ? "hover:bg-black/90" : "hover:bg-gray-100"
                } border-black border-solid border-[1px] flex items-center justify-center rounded-full text-[16px] font-[500] cursor-pointer transition-colors`}
              ...
              <div
                className={`py-[7px] px-[25px] ${
                  selectedSize === 3 ? "text-white" : "text-black"
                } ${selectedSize === 3 ? "bg-black" : "bg-white"} ${
                  selectedSize === 3 ? "hover:bg-black/90" : "hover:bg-gray-100"
                } border-black border-solid border-[1px] flex items-center justify-center rounded-full text-[16px] font-[500] cursor-pointer transition-colors`}
              ...
              <div
                className={`py-[7px] px-[25px] ${
                  selectedSize === 4 ? "text-white" : "text-black"
                } ${selectedSize === 4 ? "bg-black" : "bg-white"} ${
                  selectedSize === 4 ? "hover:bg-black/90" : "hover:bg-gray-100"
                } border-black border-solid border-[1px] flex items-center justify-center rounded-full text-[16px] font-[500] cursor-pointer transition-colors`}
          ...
          <div className="flex justify-between gap-[20px] mt-[50px]">
            <Link
              to={"/checkout"}
              className="py-[10px] px-[20px] bg-black text-white flex items-center justify-center border-black border-solid border-[1px] cursor-pointer hover:bg-black/90 w-full transition-colors"
            >
              <span>Buy Now</span>
            </Link>
            <div className="py-[10px] px-[20px] bg-white text-black border-black border-solid border-[1px] flex items-center justify-center hover:bg-gray-100 cursor-pointer w-full transition-colors">
