  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <div className="flex flex-col gap-[10px] border-b-[1px] border-b-black border-b-[solid] pb-[20px] w-fit">
        {/* title */}
        <span className="Outfit text-[25px] font-[500]">Colour</span>

        {/* filter Items */}
        <div className="Poppins flex items-center gap-[10px]">
          {/* item 1 */}
          <div className="flex items-center justify-center p-[5px] rounded-full px-[20px] bg-[#D7CFCF] hover:bg-[#beb7b7] cursor-pointer">
            <span>White</span>
          </div>
          {/* item 2 */}
          <div className="flex items-center justify-center p-[5px] rounded-full px-[20px] bg-[#926C15] hover:bg-[#795911] cursor-pointer">
            <span>Yellow</span>
          </div>
          {/* item 3 */}
          <div className="flex items-center justify-center p-[5px] rounded-full px-[20px] bg-[#EC9FD2] hover:bg-[#d687bc]  cursor-pointer">
            <span>Rose</span>
          </div>
        </div>
      </div>
