      ...
      <div className="flex gap-[50px] flex-col md:flex-row">
                ...
                <div className="border-[1px] rounded-md overflow-hidden border-solid border-black flex w-fit">
                  <div
                    className={`py-[10px] px-[20px] ${
                      selectedGen === 0 ? "bg-black" : "bg-white"
                  ...
                  <div
                    className={`py-[10px] px-[20px]  flex items-center justify-center  text-black cursor-pointer ${
                      selectedGen === 1 ? "bg-black" : "bg-white"
                    } ${
                      selectedGen === 1
                        ? "hover:bg-black/90"
                        : "hover:bg-gray-100"
        ...
        <div className="flex-[1]">
          ...
          <div className="flex flex-col Outfit mt-[50px] gap-[20px]">
            ...
            <div className="flex items-center flex-col md:flex-row md:justify-between gap-[10px] md:gap-0">
              <input
                ...
                className="p-[10px] border-gray-300 w-full md:w-fit border-solid border-[1px] outline-none"
              />
              <button className="px-[40px] w-full py-[10px] bg-black md:w-fit text-white cursor-pointer hover:bg-black/90">
                Redeem
              </button>
            </div>
          </div>
          ...
          <div className="Outfit mt-[50px]">
            {/* button */}
            <div>
              <div className="flex items-center justify-center p-[10px] bg-black text-white cursor-pointer hover:bg-black/90">
